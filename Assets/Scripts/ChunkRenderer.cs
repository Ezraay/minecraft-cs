            ...
            for (int y = 0, i = 0; y < Chunk.BuildHeight; y++)
            {
                for (int x = 0; x < Chunk.ChunkSize; x++)
                {
                    for (int z = 0; z < Chunk.ChunkSize; z++)
                    {
                        ...
                        bool renderLeftFace = chunk.GetBlock(position + Vector3Int.left) == 0;
                        bool renderRightFace = chunk.GetBlock(position + Vector3Int.right) == 0;
                        bool renderFrontFace = chunk.GetBlock(position + Vector3Int.back) == 0;
                        bool renderBackFace = chunk.GetBlock(position + Vector3Int.forward) == 0;
                        bool renderTopFace = chunk.GetBlock(position + Vector3Int.up) == 0;
                        bool renderBottomFace = chunk.GetBlock(position + Vector3Int.down) == 0;
                        ...
                        if (blockID != 0)
                        {
                            ...
                            if (renderBottomFace)
                            {
                                ...
                                uv.Add(bottomTile + oneTile);
                                uv.Add(bottomTile + Vector2.up * oneTile);
                                uv.Add(bottomTile);
                                uv.Add(bottomTile + Vector2.right * oneTile);
                            ...
                            if (renderFrontFace)
                            {
                                ...
                                uv.Add(sideTile + oneTile);
                                uv.Add(sideTile + Vector2.up * oneTile);
                                uv.Add(sideTile);
                                uv.Add(sideTile + Vector2.right * oneTile);
                            ...
                            if (renderTopFace)
                            {
                                ...
                                uv.Add(topTile + oneTile);
                                uv.Add(topTile + Vector2.up * oneTile);
                                uv.Add(topTile);
                                uv.Add(topTile + Vector2.right * oneTile);
...
//                             } ;
                            ...
                            //     bool bottom = j == 5;
                            //     
                            //     triangles.Add(i * 24 + 3);
                            //     triangles.Add(i * 24 + 1);
                            //     triangles.Add(i * 24);
                            //     triangles.Add(i * 24 + 3);
                            //     triangles.Add(i * 24 + 2);
                            //     triangles.Add(i * 24 + 1);
                            // }
                            ...
                            // triangles.Add(i * 24 + 7);
                            // triangles.Add(i * 24 + 5);
                            // triangles.Add(i * 24 + 4);
                            // triangles.Add(i * 24 + 7);
                            // triangles.Add(i * 24 + 6);
                            // triangles.Add(i * 24 + 5);
                            ...
                            // triangles.Add(i * 24 + 11);
                            // triangles.Add(i * 24 + 9);
                            // triangles.Add(i * 24 + 8);
                            // triangles.Add(i * 24 + 11);
                            // triangles.Add(i * 24 + 10);
                            // triangles.Add(i * 24 + 9);
                            ...
                            // triangles.Add(i * 24 + 15);
                            // triangles.Add(i * 24 + 13);
                            // triangles.Add(i * 24 + 12);
                            // triangles.Add(i * 24 + 15);
                            // triangles.Add(i * 24 + 14);
                            // triangles.Add(i * 24 + 13);
                            ...
                            // triangles.Add(i * 24 + 19);
                            // triangles.Add(i * 24 + 17);
                            // triangles.Add(i * 24 + 16);
                            // triangles.Add(i * 24 + 19);
                            // triangles.Add(i * 24 + 18);
                            // triangles.Add(i * 24 + 17);
                            ...
                            // triangles.Add(i * 24 + 23);
                            // triangles.Add(i * 24 + 21);
                            // triangles.Add(i * 24 + 20);
                            // triangles.Add(i * 24 + 23);
                            // triangles.Add(i * 24 + 22);
                            // triangles.Add(i * 24 + 21);
